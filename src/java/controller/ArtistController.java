...
public class ArtistController implements Serializable {
    ...
    @EJB
    private bean.ArtistFacade ejbFacade;
    ...
    public void setSelected(Artist selected) {
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Bundle").getString("ArtistUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Bundle").getString("ArtistDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public Artist getArtist(java.lang.Long id) {
        return getFacade().find(id);
    }

    public List<Artist> getItemsAvailableSelectMany() {
        return getFacade().findAll();
    }

    public List<Artist> getItemsAvailableSelectOne() {
        return getFacade().findAll();
    }
    ...
    public static class ArtistControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Artist) {
                ...
                Logger.getLogger(this.getClass().getName()).log(Level.SEVERE, "object {0} is of type {1}; expected type: {2}", new Object[]{object, object.getClass().getName(), Artist.class.getName()});
                return null;
            }
        }
